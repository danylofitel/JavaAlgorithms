...
import collections.IndexMinPriorityQueue;
...
public class PrimMST {
    ...
    public PrimMST(EdgeWeightedUndirectedGraph G) {
    ...
    public Iterable<Edge> edges() {
        Queue<Edge> mst = new QueueOnArray<>();
    ...
    private boolean check(EdgeWeightedUndirectedGraph G) {
        ...
        if (Math.abs(totalWeight - weight()) > PRECISION) {
